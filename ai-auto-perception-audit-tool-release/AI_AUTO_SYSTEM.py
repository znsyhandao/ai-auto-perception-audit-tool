...
def save_to_knowledge_base(lessons):
    ...
    if new_count > 0:
        ...
        # Check if framework upgrade is needed
...
def check_framework_upgrades(lessons):
    ...
    # Check enhanced audit framework
    ...
    if enhanced_framework.exists():
        ...
        # Check if it includes today's lessons
        try:
            with open(enhanced_framework, 'r', encoding='utf-8') as f:
                content = f.read()
            
            # Check if contains 2026-04-03 lessons
...
def audit_skill(skill_path):
    ...
    # 1. Run enhanced audit framework
    ...
    if enhanced_framework.exists():
        ...
        try:
            # Use byte stream, manual UTF-8 decoding
            ...
            try:
                ...
                system_encoding = sys.getfilesystemencoding() or 'utf-8'
